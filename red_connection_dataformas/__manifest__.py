...
#################################################################################
{
    'name': 'RED dataformas CONNECTOR',
    'version': '18.0.0.1',
    'summary': 'Module to integrate dataformas products with systems.',
    'description': 'Module to integrate dataformas products with systems.',
    'category': 'Product',
